...
@section('content')
    ...
    <div class="hero-area owl-carousel">
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            <a href="{{url('video-post')}}" class="post-title" data-animation="fadeInUp" data-delay="300ms">Mnet Asian Music Award - MAMA</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url(assets/frontend/img/core-img/melon1.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <!-- Post Contetnt -->
                        <div class="post-content text-center">
                            ...
                            <a href="{{url('video-post')}}" class="post-title" data-animation="fadeInUp" data-delay="300ms">Melon Music Award - MMA</a>
        ...
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url(assets/frontend/img/core-img/goldendisk1.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <!-- Post Contetnt -->
                        <div class="post-content text-center">
                            ...
                            <a href="{{url('video-post')}}" class="post-title" data-animation="fadeInUp" data-delay="300ms">골든 디스크 어워드 - GDA</a>
                            <a href="{{url('video-post')}}" class="video-play" data-animation="bounceIn" data-delay="500ms"><i class="fa fa-play"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget">
                <a href="{{url('about')}}" class="add-img"><img src="assets/frontend/img/core-img/logo3.png" alt=""></a>
            </div>
                    ...
                    $(".videoolahraga").append(
                        ...
                        <div class="post-content">
                            <div class="post-meta">
                                ...
                                <a href="${value.slug}">${value.id_kategori}</a>
                            </div>
                            <a href="/single-post/${value.slug}" class="post-title">${value.judul}</a>
                            <p>${value.konten}</p>
                        </div>
