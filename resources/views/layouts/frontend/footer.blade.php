 <!-- >>>>>>>>>>>>>>>>>>>>
        ...
        <div class="post-sidebar-area right-sidebar mt-30 mb-30 box-shadow">
            ...
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="assets/frontend/img/core-img/logo3.png" alt=""></a>
            </div>
        </div>
    </section>
    <!-- ##### Mag Posts Area End ##### -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <!-- Logo -->
                        <a href="index.html" class="foo-logo"><img src="assets/frontend/img/core-img/Logo1.png" alt=""></a>
                        <p>(Korean Hangout) KH adalah sebuah website buatan anak SMK Assalaam ,yang bertujuan untuk mengumpulkan beberapa berita terikini seputar dunia K-pop. </p>
